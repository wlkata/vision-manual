...
thresholds = [(0, 100, 25, 127, -128, 127), #红
              (0, 100, -128, -18, 11, 127), #绿
              (1, 100, -128, 127, -128, -20)] #蓝
              #(42, 67, -9, 15, 19, 127)
# 设置led的pwm输出
tim = Timer(4, freq=1000)           # 赫兹的频率
